...
corr = correlator_horizontal(peps, peps, env, σz, σz, (CartesianIndex(1, 1), CartesianIndex(1, 21))) .- magnz^2
corr_2 = correlator_horizontal(peps, peps, env, σz ⊗ σz, (CartesianIndex(1, 1), CartesianIndex(1, 21))) .- magnz^2
